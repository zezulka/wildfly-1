 ...
 * to current transction context of wildfly transaction client.
 *
 * @author Ondrej Chaloupka <ochaloup@redhat.com>
 */
public class WildflySuordinateTransactionImporter implements TransactionImporter {

    @Override
    public Transaction importTransaction(Xid xid) throws XAException {
