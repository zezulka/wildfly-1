...
package org.jboss.as.test.integration.ejb.ejb2.ejb3refer.global;
...
public class GlobalSession30Bean implements Session30RemoteBusiness {
    ...
    public String globalAccess21() {
        try {
            ...
            Session21Home home = (Session21Home) jndiContext.lookup("java:global/global-reference-ejb2/Session21Remote");
            // Session21Home home = (Session21Home) jndiContext.lookup("java:global/global-reference-ejb2/Session21!org.jboss.as.test.integration.ejb.ejb2.ejb3refer.global.Session21Home");
