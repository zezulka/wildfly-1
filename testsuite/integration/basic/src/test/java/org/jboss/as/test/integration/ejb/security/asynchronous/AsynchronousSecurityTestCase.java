...
public class AsynchronousSecurityTestCase extends SecurityTest{
    ...
    public static Archive<?> deploy() {
        try {
            ...
            createSecurityDomain("asynctest");
        } catch (Exception e) {
            // ignore
        }
        ...
        jar.addClass(AnnotationAuthorizationTestCase.class).addClass(SecurityTest.class);
    ...
    public static void tearDown() throws Exception {
        removeSecurityDomain("asynctest");
    }
