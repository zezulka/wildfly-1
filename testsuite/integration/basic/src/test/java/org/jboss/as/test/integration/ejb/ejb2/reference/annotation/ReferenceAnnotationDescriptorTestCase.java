    ...
    public static Archive<?> deployment() {
        final JavaArchive jar = ShrinkWrap.create(JavaArchive.class, "reference-ejb2-ejb3.jar")
           ...
           .addClasses(
                   ...
                   Session21Home.class, 
                   Session21Bean.class);
        jar.addAsManifestResource(ReferenceAnnotationDescriptorTestCase.class.getPackage(), "jboss-ejb3-reference.xml", "jboss-ejb3.xml");
        jar.addAsManifestResource(ReferenceAnnotationDescriptorTestCase.class.getPackage(), "ejb-jar-reference.xml", "ejb-jar.xml");
        /* jar.addAsManifestResource(ReferenceAnnotationDescriptorTestCase.class.getPackage(), "roles.properties", "roles.properties");
        jar.addAsManifestResource(ReferenceAnnotationDescriptorTestCase.class.getPackage(), "users.properties", "users.properties"); */
