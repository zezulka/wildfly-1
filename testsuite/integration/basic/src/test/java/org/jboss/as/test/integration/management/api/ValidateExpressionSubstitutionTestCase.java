 ...
 * Validation of expression settings to parameters globaly could be found at domain module in test: ExpressionSupportSmokeTestCase
 * 
 * @author <a href="ochaloup@jboss.com">Ondrej Chaloupka</a>
 */
@RunWith(Arquillian.class)
@RunAsClient
public class ValidateExpressionSubstitutionTestCase {
