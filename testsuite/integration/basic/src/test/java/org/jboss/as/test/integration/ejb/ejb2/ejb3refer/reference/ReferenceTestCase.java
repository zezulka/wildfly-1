...
package org.jboss.as.test.integration.ejb.ejb2.ejb3refer.reference;
...
import org.jboss.as.test.integration.ejb.ejb2.ejb3refer.global.Session21;
import org.jboss.as.test.integration.ejb.ejb2.ejb3refer.global.Session21Bean;
import org.jboss.as.test.integration.ejb.ejb2.ejb3refer.global.Session21Home;
import org.jboss.as.test.integration.ejb.ejb2.ejb3refer.global.Session30;
import org.jboss.as.test.integration.ejb.ejb2.ejb3refer.global.Session30RemoteBusiness;
...
public class ReferenceTestCase {
    ...
    public static Archive<?> deployment() {
        final JavaArchive jar = ShrinkWrap.create(JavaArchive.class, "reference-ejb2-ejb3.jar")
           .addClasses(
                   ...
                   LocalSession30.class, LocalSession30Business.class, 
                   LocalStatefulSession30.class, LocalStatefulSession30Business.class,
                   ReferenceTestCase.class,
                   Session30.class, Session30Home.class, Session30LocalHome.class, 
                   StatefulSession30.class, 
                   //StatefulSession30Bean.class, 
                   StatefulSession30Home.class, StatefulSession30LocalHome.class,
                   StatefulSession30RemoteBusiness.class
                   )
           .addClasses(Session30.class, Session30RemoteBusiness.class, Session21.class, Session21Home.class, Session21Bean.class);
        jar.addAsManifestResource(ReferenceTestCase.class.getPackage(), "jboss-reference.xml", "jboss.xml");
        jar.addAsManifestResource(ReferenceTestCase.class.getPackage(), "ejb-jar-reference.xml", "ejb-jar.xml");
        jar.addAsManifestResource(ReferenceTestCase.class.getPackage(), "roles.properties", "roles.properties");
        jar.addAsManifestResource(ReferenceTestCase.class.getPackage(), "users.properties", "users.properties");
    ...
    public void testStatefulSessionHome30() throws Exception {
        ...
        StatefulSession30RemoteBusiness session = (StatefulSession30RemoteBusiness) jndiContext
