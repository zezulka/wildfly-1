...
public class TestPassivationBean implements TestPassivationRemote {
    ...
    public void postConstruct() {
        ...
        log.info("Bean created... " + this.identificator);
    }
    
    @PreDestroy
    public void preDestroy() {
        log.info("Bean destroyed" + this.identificator);
    }
    ...
    public void setActivateFlag() {
        log.info(this.toString() + " Activated." + this.identificator);
        this.beenActivated = true;
    }
    
    @Remove
    public void remove() {
        log.info("Removing..." + this.identificator);
    }
}
