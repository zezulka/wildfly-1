...
public class GlobalReferenceTestCase {
    ...
    public static Archive<?> deploymentEjb2() {
        ...
        log.info(jar.toString(true));
        jar.addAsManifestResource(GlobalReferenceTestCase.class.getPackage(), "jboss-global.xml", "jboss.xml");
        // jar.addAsManifestResource(GlobalReferenceTestCase.class.getPackage(), "jboss-ejb3.xml", "jboss-ejb3.xml");
