...
public class StatefulSession30Bean implements java.io.Serializable, StatefulSession30RemoteBusiness {
    ...
    public String accessLocalStateless() {
        try {
            ...
            Session30LocalHome localHome = (Session30LocalHome) jndiContext.lookup(Session30LocalHome.JNDI_NAME_SESSION_30);
    ...
    public String accessLocalHome() {
        try {
            InitialContext jndiContext = new InitialContext();
            StatefulSession30LocalHome home = (StatefulSession30LocalHome) jndiContext
                    .lookup("HomedStatefulSession30/localHome");
