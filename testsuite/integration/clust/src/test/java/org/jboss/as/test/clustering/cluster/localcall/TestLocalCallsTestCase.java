...
/**
 * Calling clustered annotated beans on one (local) machine.
 * 
 * @author Kabir Khan, Ondrej Chaloupka
 */
@RunWith(Arquillian.class)
@RunAsClient
public class TestLocalCallsTestCase {
    private static final Logger log = Logger.getLogger(TestLocalCallsTestCase.class);
    ...
    public static Archive<?> deployment() throws Exception {
        ...
        jar.addPackage(TestLocalCallsTestCase.class.getPackage());
    ...
    private InitialContext getInitialContext() throws Exception {
        if(initalContext == null) {
            ...
            env.put(Context.PROVIDER_URL, "remote://localhost:4447"); // FIXME: how to change this?
    ...
    public void testAsynchronousCalls() throws Exception {
        ...
        testAsynchronousBeanCall(statelessClustered);
        ...
        testAsynchronousBeanCall(statefulClustered);
    }

    private void testAsynchronousBeanCall(RemoteAsyncInterface asyncClusteredBean) throws Exception {
        InitialContext ctx = getInitialContext();
