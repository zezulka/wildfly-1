...
import org.jboss.as.test.xts.newxts.wsat.service.ATService1;
import org.jboss.as.test.xts.newxts.wsat.service.ATService2;
import org.jboss.as.test.xts.newxts.wsat.service.ATService3;
...
public class ATTestCase extends BaseFunctionalTest {
    ...
    private void assertEventLog(String eventLogName, EventLogEvent... expectedOrder) {
        Assert.assertEquals(Arrays.asList(expectedOrder), getEventLog().getEventLog(eventLogName));
    }
