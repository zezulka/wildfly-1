...
public class BACoordinationCompletionParticipant implements BusinessAgreementWithCoordinatorCompletionParticipant, ConfirmCompletedParticipant,
    ...
    /**
     * Just private method which do rollback.
     */
    private void doCompensate() {
        log.info("[BA COORDINATOR COMPL SERVICE] Participant doCompensate() - rollbacking values");
        // Carrying out compensation action
