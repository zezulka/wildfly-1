...
public class ATClient {
    ...
    // Integer.getInteger("as.managementPort", 9999);
    ...
    public static AT newInstance() throws Exception {
        ...
        URL wsdlLocation = new URL("http://" + NODE0_ADDR + ":" + NODE0_PORT + "/" + ATTestCase.ARCHIVE_NAME + "/ATService?wsdl");
        log.info("wsdlLocation for service: " + wsdlLocation);
        QName serviceName = new QName(TARGET_NAMESPACE, "ATService");
        QName portName = new QName(TARGET_NAMESPACE, "AT");
