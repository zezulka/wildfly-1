 ...
 * @version $Revision: 103370 $
 */
@MessageDriven(activationConfig = {
   @ActivationConfigProperty(propertyName="destinationType", propertyValue="javax.jms.Queue"),
   @ActivationConfigProperty(propertyName="destination", propertyValue="queue/test")
   // @ActivationConfigProperty(propertyName="destination", propertyValue="queue/mdbtest") // hornetq-jms.xml not working for some reason
})
@RunAs("TestRole")
@SecurityDomain(value="other",unauthenticatedPrincipal="user")
// @Depends("org.hornetq:module=JMS,type=Queue,name=\"mdbtest\"") // probably not needed anymore
@ResourceAdapter(value = "hornetq-ra.rar") // hard to say why is this needed here - based on documentation to as 7
public class QueueTestMDB implements MessageListener
{
   private Logger log = Logger.getLogger(QueueTestMDB.class); 
