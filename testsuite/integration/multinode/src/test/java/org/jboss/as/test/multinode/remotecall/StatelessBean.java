...
public class StatelessBean {
    ...
    public void localCall() throws Exception {
        ...
        StatefulLocal stateful = (StatefulLocal) jndiContext.lookup("java:module/" + 
    ...
    public void localHomeCall() throws Exception {
        ...
        StatefulLocalHome statefulHome = (StatefulLocalHome) jndiContext.lookup("ejb:/" + 
                StatefulBean.class.getSimpleName() + "!" + StatefulLocalHome.class.getName());
    ...
    public int remoteCall() throws Exception {
        ...
        StatelessRemote stateless = (StatelessRemote) jndiContext.lookup("ejb:/" + RemoteLocalCallTestCase.ARCHIVE_NAME + "//"
    ...
    public int remoteHomeCall() throws Exception {
        ...
        StatelessRemoteHome statelessHome = (StatelessRemoteHome) jndiContext.lookup("ejb:/"
                + RemoteLocalCallTestCase.ARCHIVE_NAME + "//" + StatelessBean.class.getSimpleName() + "!"
