...
public class StatefulBean {
    ...
    public void localCall() throws Exception {
        ...
        StatelessLocal stateless = (StatelessLocal) jndiContext.lookup("ejb:/" + RemoteLocalCallTestCase.ARCHIVE_NAME + "//" +
    ...
    public void localHomeCall() throws Exception {
        ...
        StatelessLocalHome statelessHome = (StatelessLocalHome) jndiContext.lookup("ejb:/" + RemoteLocalCallTestCase.ARCHIVE_NAME + "//" +
                StatelessBean.class.getSimpleName() + "!" + StatelessLocalHome.class.getName());
    ...
    public int remoteCall() throws Exception {
        ...
        StatefulRemote stateful = (StatefulRemote) jndiContext.lookup("ejb:/" + RemoteLocalCallTestCase.ARCHIVE_NAME + "//"
                + StatefulBean.class.getSimpleName() + "!" + StatefulRemote.class.getName());
    ...
    public int remoteHomeCall() throws Exception {
        ...
        StatefulRemoteHome statefulHome = (StatefulRemoteHome) jndiContext.lookup("ejb:/" + RemoteLocalCallTestCase.ARCHIVE_NAME + "//"
