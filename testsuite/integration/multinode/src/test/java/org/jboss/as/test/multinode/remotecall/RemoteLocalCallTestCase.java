...
public class RemoteLocalCallTestCase {
    ...
    public static final String ARCHIVE_NAME = "remotelocalcall-test";
    ...
    private static JavaArchive createJar() {
        JavaArchive jar = ShrinkWrap.create(JavaArchive.class, ARCHIVE_NAME + ".jar");
        jar.addPackage(RemoteLocalCallTestCase.class.getPackage());
        return jar;
    }
